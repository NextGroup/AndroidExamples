...
public class MainActivity extends ActionBarActivity implements LoaderManager.LoaderCallbacks<Cursor>{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * mainController의 인스턴스를 가져오고 Context를 현재의 Context로 설정 후 mainController의
		 * 메서드를 이용해 Database초기화
		 */
		...
		/*
		 * 로더를 생성 보통 Activity의 onCreate나 fragment의 onActivityCreated안에 생성 args :
		 * loader의 unique아이디, loader에 넘길 추가 인자, LoaderManager.LoaderCallbacks을
		 * 구현한곳
		 */
	...
	/*
	 * ActionBar Compat을 사용하기 위해 onCreateOptionsMenu를 구현한다. R.menu.main은 직접 구현한
	 * xml
	 */
	@Override
	...
	/*
	 * onOptionsItemSelected를 사용해 Actionbar에 있는 아이템의 이벤트를 받을 수 있다. MenuItem
	 * item.getItemId()를 통해 어떠한 버튼이 눌렸는지 확인할 수 있음
	 */
	@Override
